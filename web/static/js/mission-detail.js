...
var GroupTableInit = function () {
    ...
    //初始化Table
    oTableInit.Init = function (mission_id) {
        $('#group_table').bootstrapTable({
            url: '/mission-detail-json-' + mission_id + '.html',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
                ...
                {
                    field: 'mission_projects__name',
                    title: 'Project'
                },
                {
                    field: 'status',
                    title: 'Publish Status',
                    formatter: publish_statusFormatter
                },
                // {
                //     field: 'name',
                //     title: 'Options',
...
function publish_statusFormatter(value, row, index) {
        if (value == 0) {
            return '<a type="button" class="btn btn-warning btn-xs">Publish <img src="/static/imgs/loading_oblong.gif"></a>'
        }
    }
